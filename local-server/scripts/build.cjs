...
for (const file of ["box-upload.cjs", "build-source.cjs", "codex-translation.cjs", "filehandler-client.cjs", "git-eol-local.cjs", "openxml-client.cjs", "settings.cjs", "updater.cjs", "version.cjs"]) {
