DO $$
BEGIN
    CREATE TYPE user_role AS ENUM ('admin', 'dev', 'qa');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS user_settings (
    ...
    git_eol_source_folder TEXT,
    document_translation_output_directory TEXT,
    document_translation_direction VARCHAR(20),
    document_translation_model VARCHAR(100),
    document_translation_reasoning_effort VARCHAR(20),
    document_translation_timeout_seconds INTEGER,
    document_translation_batch_size INTEGER,
    document_translation_context_window INTEGER,
    document_translation_fast_mode BOOLEAN,
    document_translation_glossary TEXT,
    document_translation_instructions TEXT,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
