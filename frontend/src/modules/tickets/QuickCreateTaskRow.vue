...
<template>
  <div :class="`grid bg-[#F8FAFF] px-2 py-2 pr-6 last:rounded-b-xl border-t border-neutral-200 ${from === 'detail' ? 'md:grid-cols-[160px_minmax(0,1fr)]' : from === 'logtime' ? 'md:grid-cols-[140px_minmax(0,1fr)]' : 'md:grid-cols-[120px_minmax(0,1fr)]'}`">
